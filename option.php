        ...
        echo '
            <script type="text/javascript">
                var QRCode = new QRCode("mobassist_qr_code", {
                    text: "' . sanitize_textarea_field($qr_config) . '",
                    width: 250,
                    height: 250,
                    colorDark : "#000000",
                    colorLight : "#ffffff",
        ...
        <div class="sa_wrap">
			...
			<div class="sa_sidebar">
				...
				<h3>Get the App from Google Play</h3>
					<a class="ma_play" href="https://play.google.com/store/apps/details?id=com.emagicone.assistant.wooCommerce" target="_blank" ><img src="http://api.qrserver.com/v1/create-qr-code/?color=000000&bgcolor=FFFFFF&data=https%3A%2F%2Fplay.google.com%2Fstore%2Fapps%2Fdetails%3Fid%3Dcom.emagicone.assistant.wooCommerce&size=200x200" alt="Get the App from Google Play">
